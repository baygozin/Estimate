...
namespace EstimatesAssembly {
    public partial class MainFormAsm : Form {
        ...
        private void btnAddSheet_Click(object sender, EventArgs e) {
            ...
            if (chbSort.Checked) {
                _book.SortWorksheets(ref _pgBar);
            }
            if (chbNumeric.Checked) {
                _book.NumberingPage(ref _pgBar);
            }
            if (chbSave.Checked) {
                _book.SaveWorkbook();
            }
        ...
        private void btnDelSheet_Click(object sender, EventArgs e) {
            ...
            _book.DeleteSheet(lstSheet.SelectedItems, ref _pgBar);
            FillListSheet(_book.GetListSheet());
        }
        ...
        private void button3_Click(object sender, EventArgs e) {
            _book.AdaptionSheets(ref _pgBar);
        }
        ...
        private void employeesDictToolStripMenuItem_Click(object sender, EventArgs e)
        {
            new FormHandBook().Show();
        }
